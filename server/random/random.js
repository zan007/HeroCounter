var server = require('../server'),
	...
	fs = require('fs'),
	path = require('path'),
	creatures = JSON.parse(fs.readFileSync(path.join(server.dirName,'random','creatures.json'))),
	players = JSON.parse(fs.readFileSync(path.join(server.dirName,'random','players.json'))),
	otherPlayers = JSON.parse(fs.readFileSync(path.join(server.dirName,'random','other-players-with-lvl.json'))),
