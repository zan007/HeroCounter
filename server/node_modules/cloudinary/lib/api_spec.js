...
(function() {
  var IMAGE_FILE, Q, TEST_TAG, _, cloudinary, expect, fs, helper, utils;
  ...
  describe("api", function() {
    var PUBLIC_ID, find_by_attr, upload_image;
    ...
    before(function(done) {
      this.timeout(0);
      this.timestamp_tag = TEST_TAG + "_" + (cloudinary.utils.timestamp());
      return cloudinary.v2.api.delete_resources([PUBLIC_ID, "api_test1", "api_test2"], function(error, result) {
        return Q.all([
          cloudinary.v2.uploader.upload(IMAGE_FILE, {
            public_id: PUBLIC_ID,
            tags: [TEST_TAG, this.timestamp_tag],
            context: "key=value",
            eager: [
              {
                width: 100,
    ...
    describe("update", function() {
      it("should support settings manual moderation status", function(done) {
        this.timeout(helper.TIMEOUT_MEDIUM);
        return cloudinary.v2.uploader.upload(IMAGE_FILE, {
          moderation: "manual"
        }, function(error, upload_result) {
